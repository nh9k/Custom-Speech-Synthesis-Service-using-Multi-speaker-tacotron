import codecs #it does not exit in the origianal
import re
import os
import sys
import m3u8
...
def download_news_video_and_content(
    ...
    with codecs.open(original_text_path, "w","utf-8") as f: #open(original_text_path,'w') as...
        f.write(text)  

    with codecs.open(text_path, "w","utf-8") as f: #open(text_path,'w') as...
